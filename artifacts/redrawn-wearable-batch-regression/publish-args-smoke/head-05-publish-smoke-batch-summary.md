# head-05-publish-smoke redrawn wearable batch
...
- Failed cells: none
- 4x proof: C:\Users\kochu\Documents\BuiO\artifacts\redrawn-wearable-batch-regression\publish-args-smoke\proof-4x\all-frames-left-vs-right-4x.png
- Expected PASS comparison: not requested

- Publish args ready: yes (not executed)
