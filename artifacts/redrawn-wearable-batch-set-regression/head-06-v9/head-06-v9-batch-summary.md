# head-06-v9 redrawn wearable batch
...
- frontErase source QA: NOT_REQUIRED
- Failed cells: none
- 4x proof: C:\Users\kochu\Documents\BuiO\artifacts\redrawn-wearable-batch-set-regression\head-06-v9\proof-4x\all-frames-left-vs-right-4x.png
- Expected PASS comparison: PASS

- Layer manifest audit: DATA_PASS — C:\Users\kochu\Documents\BuiO\artifacts\redrawn-wearable-batch-set-regression\head-06-v9\head-06-v9-layer-manifest-audit.json
