...
app.use('/css', express.static(path.join(__dirname, 'math-app', 'public', 'css')));
app.use('/js', express.static(path.join(__dirname, 'math-app', 'public', 'js')));
app.use('/images', express.static(path.join(__dirname, 'math-app', 'public', 'images')));
...
// (從 whiteboard-app/server/index.js 整合)
// ========================================
const rooms = new Map();
